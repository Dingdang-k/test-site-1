...
// Create the popup
map1.on('click', 'Business Category', function (e) {
...
map1.on('mouseenter', 'Business Category', function () {
    map1.getCanvas().style.cursor = 'pointer';
});
// Change it back to a pointer when it leaves.
map1.on('mouseleave', 'Business Category', function () {
